                    ...
                    <div class="card mt-2 mb-4">
                        <div class="card-body">
                            <h5>Form Penilaian</h5>
                              <div class="mt-2">
                                <form method="POST" action="{{ route('editDetailNilai', ['id_kelas' => 9]) }}" enctype = "multipart/form-data" id="form">
                                    @csrf
                                    <div class="row">
                                        @foreach($data_nilai as $mhs)
                                        @if($mhs->bobot > 0)
                                        <div class="mb-3 col-md-6" style="display: block" id="idFormPartisipatif">
                                            <label class="form-label">{{ $mhs->nama_komponen }} | {{ $mhs->bobot }}%</label>
                                                <input type="number" name="id_kontrak[]" class="form-control border border-2 p-2 mb-2" value="{{ $mhs->id_kontrak }}" hidden>
                                                <input type="number" name="id_bobot[]" class="form-control border border-2 p-2 mb-2" value="{{ $mhs->id_bobot }}" hidden>
                                                <input type="number" name="bobot[]" class="form-control border border-2 p-2 mb-2" value="{{ $mhs->bobot }}" hidden>
                                                <input type="number" name="nilai[]" class="form-control border border-2 p-2 mb-2" value="{{ $mhs->nilai }}">
